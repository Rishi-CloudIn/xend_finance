    ...
    <>
      <div className='container journey-container mt-5'>
        <div className='journey-content-div py-5'>
          ...
          <p className='journey-p text-center'>GB Finance has crossed many incredible milestones, with many more to come. Below is a detailed roadmap that lays out the past, the present, and a little sneak-peak into the future.</p>
