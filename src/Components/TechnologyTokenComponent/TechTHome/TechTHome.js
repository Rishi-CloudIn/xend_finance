            ...
            <div className='row'>
              <div className='col-lg-4 col-12 p-3 '>
                <div className='card token-home-div-1 h-100'>
                  ...
                  <p className='token-home-p'>The GB Finance lending protocol aggregator – unlike other DeFi protocols who only list other Layer-1 DeFi protocols – will automatically shift funds across different lending protocols to provide very high yields without any input from the user.</p>
                </div>
              </div>
              ...
              <div className='col-lg-4 col-12 p-3'>
                <div className='card token-home-div-1 h-100'>
                  ...
                  <h3 className='token-home-h3 py-4'>GB-Vault system</h3>
              ...
              <div className='col-lg-4 col-12 p-3'>
                <div className='card token-home-div-1 h-100'>
                  ...
                  <p className='token-home-p'>The GB Finance governance system will determine strategies that are accepted into the vaults and community members who participate in governance earn a part of the processing fees from the vault operations. The GB Finance governance system will be deployed across blockchains and users can govern on multiple blockchains.</p>
                </div>
              </div>
            </div>
          </div>
