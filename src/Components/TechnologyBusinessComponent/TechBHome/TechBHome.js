        ...
        <div className='container-fluid mt-5'>
          <div className='container'>
            <div className='home-content-div py-md-5 py-4'>
              <h1 className='title-text text-center fw-bold w-sm-100 w-75 mx-auto linear-text'>A Global DeFi Platform for Credit Unions, Cooperatives, and Individuals</h1>
